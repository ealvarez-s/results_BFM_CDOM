...
png(file=paste(path_figures,"Figure5_profiles_nutrients.png",sep=""),width=1200, height =800, pointsize=24, family="Helvetica") 
  #par(mfcol=c(3,1))
  ...
  #################
    ...
    image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_tre,
            ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(12,26),main="", mgp=c(2.5,1,0))
    mtext(4, at=100, line=2, text=expression(paste(""^o,C,sep="")), outer=F, cex=0.7, las=1)
    ...
    ################
    legend(x=100,y=150, legend=expression(paste("COLOUR:temp ("^o, C,")  LINE: mld",sep="")), cex=1.2, text.col="white", bty="n")
    ...
    image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_tre,
            ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(0,8),main="", mgp=c(2.5,1,0))
    mtext(4, at=100, line=1.8, text=expression(paste("mmol ",m^-3,sep="")), outer=F, cex=0.7)
    ...
    ############
    legend(x=75,y=150, legend=expression(paste("COLOUR: N (",mu,"M)  LINE: nitracline")), cex=1.2, text.col="black",bty="n")
    ...
    image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_tre,
            ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(0,0.5),main="", mgp=c(2.5,1,0))
    mtext(4, at=100, line=1.8, text=expression(paste("mmol ",m^-3,sep="")), outer=F, cex=0.7)
    #axis(1, at=mid_meses, labels=F, las=1, cex.axis=0.8)
    axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=1.2)
    ...
    legend(x=280,y=150, legend=expression(paste("P (",mu,"M)")), cex=1.2, text.col="black",bty="n")
...
par(mar=c(3,4,0,2))       
       ...
       image2D(x=month, y=prof, z=climat, ylim=c(200,0), zlim=c(12,26), las=1,col=colores_tre,
               ylab="m", colkey=F, cex.lab=1.2, xlim=c(4,360), xaxs="i", xaxt="n")
   ...
   datos <- read.delim2(paste(p_dir,"nitrateDYFAMED.txt", sep=""),header=FALSE,fill=TRUE)
       ...
       image2D(x=month, y=prof, z=nit_total, ylim=c(200,0), zlim=c(0,8), las=1,col=colores_tre,
               ylab="m", colkey=F, cex.lab=1.2, xaxs="i", xlim=c(4,360), xaxt="n")
...
png(file=paste(path_figures,"Figure6_profiles_logChla.png",sep=""),width=1200, height =1000, pointsize=24, family="Helvetica") 
  ...
  cextitle=1.1
    ...
    return(res)}
      ...
      image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_chla,
              ylab="m", xlab="", xaxt="n", ylim=c(200,0),
      ...
      mtext(4, at=100, line=2, text=expression(paste("mgChl ",m^-3,sep="")), outer=F, cex=0.7)
      #axis(1, at=mid_meses, labels=F, las=1, cex.axis=0.8)
      ...
      ################# 
      legend(x=145,y=130, legend=c(expression(paste("COLOUR: TChla (","mg ", m^-3,")",sep="")),expression(paste("LINE: ",z[DCM], sep=""))),
      ...
      ###########      
      legend(x=230,y=140, legend=expression(paste(P["Chl"]^"(3)"," (","mg ", m^-3,")")), cex=1.2, text.col="white",bty="n")
      mtext(2, at=0, line=2, text="f)", cex=cexletter, font=1, las=1)
      ...
      contour(y=depth_center[196:1], x=c(1:362), z=t(fliplr(TChla_show)),levels=log10(c(0.1,0.2)),labels=c(0.1,0.2), col="white", add=T)
      ##########      
      legend(x=230,y=140, legend=expression(paste(P["Chl"]^"(2)"," (","mg ", m^-3,")")), cex=1.2, text.col="white",bty="n")
      ...
      contour(y=depth_center[196:1], x=c(1:362), z=t(fliplr(TChla_show)),levels=log10(c(0.1,0.2)),labels=c(0.1,0.2), col="white", add=T)
      ###########      
      legend(x=196,y=140, legend=expression(paste(P["Chl"]^"(1)","+",P["Chl"]^"(4)"," (","mg ", m^-3,")")), cex=1.2, text.col="white",bty="n")
    ...
    par(mar=c(3,4,0,2)) 
      ...
      image2D(x=month, y=prof, z=climat, ylim=c(200,0), zlim=c(-3,0.48), las=1,
              ylab="m", colkey=F, cex.lab=1.2, xaxs="i", xlim=c(4,360),
              col=colores_chla, xaxt="n")
      contour(x=month, y=prof, z=climat,levels=log10(c(0.2)), labels=c(0.2), col="white", add=T)
      axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=cexaxis)
      ############
      legend(x="bottomright", legend=expression(paste("TChla (","mg ", m^-3,")  ")), cex=1.2, text.col="white",bty="n")
      mtext(2, at=0, line=2, text="a)", cex=cexletter, font=1, las=1)
      ...
      climat[observedd==0]<-NA
      image2D(x=month, y=prof, z=climat, ylim=c(200,0), zlim=c(-3,0.48), las=1,
              ylab="m", colkey=F,cex.lab=1.2, xaxs="i", xlim=c(4,360),col=colores_chla, xaxt="n")
      axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=cexaxis)
      contour(x=month, y=prof, z=climat,levels=log10(c(0.1)), labels=c(0.1), col="white", add=T)
      ##########
      legend(x="bottomright", legend=expression(paste("pico-Chla (","mg ", m^-3,")  ")), cex=1.2, text.col="white",bty="n")
      mtext(2, at=0, line=2, text="b)", cex=cexletter, font=1, las=1)      
      ...
      contour(x=month, y=prof, z=climat,levels=log10(c(0.1)), labels=c(0.1), col="white", add=T)
      ###########
      legend(x="bottomright", legend=expression(paste("nano-Chla (","mg ", m^-3,")  ")), cex=1.2, text.col="white",bty="n")
      mtext(2, at=0, line=2, text="c)", cex=cexletter, font=1, las=1)
      ...
      contour(x=month, y=prof, z=climat,levels=log10(c(0.1)), labels=c(0.1), col="white", add=T)  
      ##########
      legend(x="bottomright", legend=expression(paste("micro-Chla (","mg ", m^-3,")  ")), cex=1.2, text.col="white",bty="n")
      mtext(2, at=0, line=2, text="d)", cex=cexletter, font=1, las=1)
...
png(file=paste(path_figures,"Figure7_profiles_DOC_CDOM.png",sep=""),width=1200, height = 300, pointsize=18, family="Helvetica") 
    #par(mfcol=c(3,1))
    layout(matrix(c(1,2),ncol=2, byrow=F))
        ...
        image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=viridis(100), # col=viridis(100), 
                ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(40,70),main="", mgp=c(2.5,1,0))
        mtext(4, at=100, line=2, text=expression(paste("mmol ",m^-3,sep="")), outer=F, cex=1.0)
        #axis(1, at=mid_meses, labels=F, las=1, cex.axis=0.8)
        axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=cexaxis)
        #text(x=mid_meses[seq(1,length(mid_meses),by=6)][17:25], y = par("usr")[3] + 30,
        #labels = etiquetas_meses[seq(1,length(etiquetas_meses),by=6)][17:25], xpd = NA,srt = 40,adj = 0.965,cex = 0.75) 
    ...
    ########      
        ...
        image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_chla,
                ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(1,2.4),main="", mgp=c(2.5,1,0))
        mtext(4, at=100, line=2, text=expression(paste("mgC ",m^-3,sep="")), outer=F, cex=1.0)
        #axis(1, at=mid_meses, labels=F, las=1, cex.axis=0.8)
        axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=cexaxis)
        #text(x=mid_meses[seq(1,length(mid_meses),by=6)][17:25], y = par("usr")[3] + 35,
        #labels = etiquetas_meses[seq(1,length(etiquetas_meses),by=6)][17:25], xpd = NA,srt = 40,adj = 0.965,cex = 1.2) 
      ...
      ## Thresholds for CDOM bleaching
        ...
        #TChla_show[TChla_show<1]<-1
        #TChla_show[TChla_show>2.4]<-2.4
        #image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_chla, ylab="m", xlab="", xaxt="n", ylim=c(200,0),zlim=c(0,60),main="", mgp=c(2.5,1,0))
...
png(file=paste(path_figures,"Figure8_profiles_IOPs.png",sep=""), width=1200, height =800, pointsize=24, family="Helvetica") 
        layout(matrix(c(4:6,1:3),ncol=2, byrow=F), widths = c(0.9,1))
        par(mar=c(3,4,0,4))
        par(oma=c(2,1,2.5,1))
        nombres[elegidos]
        ...
        image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_iops,
                ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(0,0.05),main="", mgp=c(2.5,1,0))
        ...
        legend(x=210,y=150, legend=expression(paste(a[PH],"(450) (", m^-1,")")), cex=1.2, text.col="white",bty="n")
        mtext(2, at=0, line=2, text="b)", cex=cexletter, font=1, las=1)
        ...
        image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_iops,
                ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(0,0.03),main="", mgp=c(2.5,1,0))
        mtext(4, at=100, line=2.4, text=expression(paste(m^-1,sep="")), outer=F, cex=0.7, las=1)
        #axis(1, at=mid_meses, labels=F, las=1, cex.axis=0.8)
        axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=cexaxis)
        #text(x=mid_meses[seq(1,length(mid_meses),by=6)][13:20], y = par("usr")[3] + 30,
        ...
        legend(x=210,y=150, legend=expression(paste(a[NAP],"(450) (", m^-1,")")), cex=1.2, text.col="white",bty="n")
        mtext(2, at=0, line=2, text="d)", cex=cexletter, font=1, las=1)
        ...
        image2D(y=depth_center, x=c(1:362), z=t(TChla_show), las=1, cex.lab=1.2, col=colores_iops,
                ylab="m", xlab="", xaxt="n", ylim=c(200,0), zlim=c(0.00,0.05),main="", mgp=c(2.5,1,0))
        mtext(4, at=100, line=2.4, text=expression(paste(m^-1,sep="")), outer=F, cex=0.7, las=1)
        #axis(1, at=mid_meses, labels=F, las=1, cex.axis=0.8)
        axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=cexaxis)
        #text(x=mid_meses[seq(1,length(mid_meses),by=6)][17:25], y = par("usr")[3] + 35,
        ...
        legend(x=120,y=130, legend=c(expression(paste("COLOUR:" ,a[CDOM],"(450) (", m^-1,")", sep="")),
...
par(mar=c(3,4,0,2))         
   ...
   ##############
      ...
      image2D(x=month, y=prof, z=climat, ylim=c(200,0), zlim=c(0,0.05), las=1,
              ylab="m", colkey=F, cex.lab=1.2, xaxs="i", xlim=c(4,360),col=colores_iops, xaxt="n")
      axis(1, at=seq(15,362-14,by=30), labels=c("J","F","M","A","M","J","J","A","S","O","N","D"), las=1, cex.axis=cexaxis)
   ##############
  ...
  ##############
      ...
      legend(x=190,y=150, legend=expression(paste(a[CDOM],"(450) (", m^-1,")   ", sep="")), cex=1.2, text.col="white",bty="n")
      mtext(2, at=0, line=2, text="e)", cex=cexletter, font=1, las=1)
