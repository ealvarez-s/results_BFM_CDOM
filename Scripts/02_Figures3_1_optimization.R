...
############## 
    ...
    png(file=paste(path_figures,"Figure4_params_along_optim_DE30_OPTM5.png",sep=""),
    ...
    #for (k in c(1:nparams)){
      ...
      mtext(3,at=-16, line=-0.4,text=parameter_letter[k], font=2, cex=cexname)
...
png(file=paste(path_figures,"Figure3_metrics_along_optim_DE30_OPTM5.png",sep=""),
    ...
    for (k in c(1:7)){
      ...
      mtext(side=3, at=10, line=0.5, text=letritas[k], cex=cexlabel, font=2)
      ###################
    }
    ##################### 
